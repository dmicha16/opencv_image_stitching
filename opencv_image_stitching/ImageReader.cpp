...
int ImageReader::get_number_images() {
	return num_images;
}

void ImageReader::read_images_(string path) {
...
vector<Mat> ImageReader::upload_images_(vector<Mat> images, vector<Size> full_img_sizes) {
